...
import { createHistogramSVG } from "src/utils/vis/histogram";
...
const D3Histogram: FunctionComponent<Props> = ({
  ...
  useLayoutEffect(() => {
    ...
    if (data) {
      const svg = createHistogramSVG(data, histogramRef, visualizationState);
  ...
  return <svg ref={histogramRef}></svg>;
};
