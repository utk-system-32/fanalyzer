...
const Documentation: NextPage = () => {
  ...
  <DashboardSidebar page="documentation" />
      ...
      <div className="container p-4 ml-5">
        <h1 className="title mb-6 text-6xl bold">Welcome to Fanalyzer</h1>
        <p className="text-2xl description ml-2 mt-3 mb-3">
        ...
        <section className="section">
          <h2 className="subtitle mb-4 mt-4 text-4xl">Getting Started:</h2>
          <p className="text-2xl ml-2 mt-3 mb-3">
          ...
          <p className="text-2xl ml-2 mb-3 mt-3">
            Go ahead and click "Create Visualization" to get started.
          </p>
        </section>

        <section className="section">
          <h2 className="subtitle mb-4 mt-4 text-4xl">Creating Visualizations:</h2>
          <p className="text-2xl ml-2 mb-3 mt-3">
          ...
          <p className="text-2xl ml-2 mt-3 mb-3 p-2">
          ...
          <p className="text-2xl ml-2 mt-3 ml-3">
        ...
        <section className="section">
          <h2 className="subtitle mb-4 mt-4 text-4xl">Posts and Sharing:</h2>
          <p className="text-2xl ml-2 mb-2">
